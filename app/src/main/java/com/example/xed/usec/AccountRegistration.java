...
public class AccountRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        mAuth.createUserWithEmailAndPassword(email_val,password_val).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()){
                                    Intent setupIntent = new Intent(AccountRegistration.this, AccountSetupActivity.class);
        ...
        mregloginBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent loginIntent = new Intent(AccountRegistration.this, LoginActivity.class);
    ...
    private void sendtomain() {
        Intent mainintent = new Intent(AccountRegistration.this, MainActivity.class);
